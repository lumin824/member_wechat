<template>
    ...
    <div>
      ...
      <div :class="{active:item.limitPromptCode==5}" @click="item.limitPromptCode==5 && signup()" style="position:fixed;bottom:0;left:0;right:0;background-color:#939393;color:#fff;text-align:center;padding:0.2rem 0;font-size:0.45rem;">
        {{limitPromptCode}}
      </div>
    </div>
</template>

...
router.beforeEach(async (to, from, next) => {
  ...
  console.log(to)
  if (store.state.user || ~['/userInfo','/registerInfo','/register','/squareInfo','/voucherDetail','/activeDetail','/sellers','/ticketsUpload','/voucher','/sell','/getPosition','/car','/carDetail','/activities'].indexOf(to.path)) {
    next()
  } else {
    goLogin()
  }

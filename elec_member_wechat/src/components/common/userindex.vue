...
border-color: #FFFFFF;color:#888888'>
    ...
    <div class="calendar-dropdown"  v-if="calendar3.show" style="float:left;position:absolute;z-index:100;width:100%">
      ...
      <mt-cell title="手机">
        <input type="text" :value="this.user.mobile" readonly="readonly" style="position:relative;left:34%;outline: none;border: medium;"><router-link to="/changePhone"><mt-button size="small">修改</mt-button></router-link>
      </mt-cell>

var site_cityUtil = (function () {
    ...
    var b = function (t) {
        ...
        if (t.length <= 3) {
            if (t.slice(t.length - 1, t.length) == "市" || t.slice(t.length - 1, t.length) == "县" || t.slice(t.length - 1, t.length) == "盟") {
                return t.slice(0, t.length - 1)
            }
        }
        var u;
        u = t.slice(t.length - 9);
        if (u == "群岛的岛礁及其海域") {
            return t.slice(0, t.length - 9)
        }
        u = t.slice(t.length - 8);
        if (u == "土家族苗族自治州" || u == "傣族景颇族自治州" || u == "哈尼族彝族自治州" || u == "布依族苗族自治州" || u == "蒙古族藏族自治州") {
            return t.slice(0, t.length - 8)
        }
        u = t.slice(t.length - 7);
        if (u == "藏族羌族自治州" || u == "壮族苗族自治州" || u == "黎族苗族自治县" || u == "苗族侗族自治州") {
            return t.slice(0, t.length - 7)
        }
        u = t.slice(t.length - 6);
        if (u == "傈僳族自治州" || u == "哈萨克自治州") {
            return t.slice(0, t.length - 6)
        }
        u = t.slice(t.length - 5);
        if (u == "彝族自治州" || u == "藏族自治州" || u == "白族自治州" || u == "傣族自治州" || u == "黎族自治县" || u == "回族自治州" || u == "蒙古自治州") {
            return t.slice(0, t.length - 5)
        }
        u = t.slice(t.length - 4);
        if (u == "") {
            return t.slice(0, t.length - 4)
        }
        u = t.slice(t.length - 3);
        if (u == "蒙古族" || u == "自治州") {
            return t.slice(0, t.length - 3)
        }
        u = t.slice(t.length - 2);
        if (u == "群岛" || u == "地区" || u == "林区") {
    ...
    var h = function (v) {
        ...
        $.each(g, function (y, x) {
            if (t && $.inArray(parseInt(x.id), t) >= 0) {
                u.push(x)
            }
        });
        return u
    ...
    var e = function (t) {
        ...
        if (t.length == 3 && t.slice(t.length - 1, t.length) == "省") {
            return t.slice(0, t.length - 1)
        }
        ...
        if (t.slice(t.length - 1, t.length) == "省") {
            return t.slice(0, t.length - 1)
        }
        return t
    };
    ...
    var a = function (t) {
        ...
        if (t.slice(t.length - 29, t.length) == "Special Administrative Region") {
            t = t.slice(0, t.length - 30)
        }
        if (t.slice(t.length - 17, t.length) == "Autonomous Region") {
            t = t.slice(0, t.length - 18)
        }
        if (t.slice(t.length - 8, t.length) == "Province" || t.slice(t.length - 8, t.length) == "province") {
            t = t.slice(0, t.length - 9)
        }
        if (t.slice(t.length - 6, t.length) == "Zhuang") {
            t = t.slice(0, t.length - 7)
        }
        if (t.slice(t.length - 5, t.length) == "Uygur") {
            t = t.slice(0, t.length - 6)
        }
        if (t.slice(t.length - 3, t.length) == "Hui") {
    ...
    var o = function (t) {
        ...
        if (t.slice(t.length - 29, t.length) == "Tibetan Autonomous Prefecture") {
            t = t.slice(0, t.length - 30)
        }
        if (t.slice(t.length - 22, t.length) == "Li and Miao Autonomous") {
            t = t.slice(0, t.length - 23)
        }
        if (t.slice(t.length - 13, t.length) == "Li Autonomous") {
            t = t.slice(0, t.length - 14)
        }
        if (t.slice(t.length - 10, t.length) == "Prefecture") {
            t = t.slice(0, t.length - 11)
        }
        if (t.slice(t.length - 9, t.length) == "Mongolian") {
            t = t.slice(0, t.length - 10)
        }
        if (t.slice(t.length - 6, t.length) == "County") {
            t = t.slice(0, t.length - 7)
        }
        if (t.slice(t.length - 4, t.length) == "City") {
            t = t.slice(0, t.length - 5)
        }
        return t
    };
    return {
        ...
        getCounty: function (t) {
            return s(t)
        },
        getInfo: function (t) {
            return n(t)
        },
        simpleProvinceName: function (t) {
            $.each(t, function (u, v) {
                t[u].name = e(t[u].name)
            })
        },
        simpleProvinceNameStr: function (t) {
            return e(t)
        },
        simpleCityName: function (t) {
            $.each(t, function (u, v) {
                t[u].name = b(t[u].name)
            })
        },
        simpleCityNameStr: function (t) {
            return b(t)
        },
        simpleProvinceNameEn: function (t) {
            $.each(t, function (u, v) {
                t[u].name = a(t[u].name)
            })
        },
        simpleCityNameEn: function (t) {
            $.each(t, function (u, v) {
                t[u].name = o(t[u].name)
            })
        },
        simpleCityNameStrEn: function (t) {
            return o(t)
        },
        simpleProvinceNameStrEn: function (t) {
            return a(t)
        },
        getProvinceEn: function (t) {
            return l(t)
        },
        getCitiesEn: function (t) {
            return q(t)
        },
        getCountyEn: function (t) {
            return q(t)
        },
        getInfoEn: function (t) {
            return d(t)
        },
        simpleCityListStr: function (x) {
            if (!x || x.length <= 0) {
                return "未添加地区"
            }
            var v = {};
        ...
        isValidProvince: function (t) {
            return k(t)
        },
        isValidCity: function (u, t) {
            return m(u, t)
        }
    }
}());
